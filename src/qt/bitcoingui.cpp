...
{
	 uiInterface.ThreadSafeMessageBox(_("This operation needs your wallet passphrase to unlock the wallet."), _("GameCoin"), CClientUIInterface::OK | CClientUIInterface::MODAL);
}
