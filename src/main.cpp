...
int64 nChainStartTime = 1455760808;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fStrictPayToScriptHash = true; // Always active in GameCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2016.02.18 GameCoin游乐币@比特游戏开启众筹";
        CTransaction txNew;
...
//        printf("block.nNonce = %u \n", block.nNonce);
        ...
        assert(block.hashMerkleRoot == uint256("0x4c9bad67c9107c0e8618d476411f1eebd998805d9f1d819267c49b6a56b30067"));
...
unsigned char pchMessageStart[4] = { 0x9a, 0x1e, 0xc0, 0x10 };
